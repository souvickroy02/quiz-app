...
function on() {
    console.log("hi");
  document.getElementById("text").innerHTML = 'Your score is ' + score + ' out of 5 <br> <button type="button" onclick="location.href='contribute.php'" class="btn btn-primary">Home</button>';
