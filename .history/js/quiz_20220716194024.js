function checkScore() {
  ...
  //   }
    // alert(score);
    console.log(document.getElementById("Questions3Ans1").value);
  _disable();
}

function _disable() {
  document.getElementById("text").innerHTML = 'Your score is ' + score + ' out of 5 <br> <button type="button" onclick="location.href="index.php"" class="btn btn-primary">Home</button>';
