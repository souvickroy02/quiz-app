...
<body>
    ...
    <div class="container">
        <div class="card-deck mt-mb-3 text-center">
            ...
            <div class="card mb-4 box-shadow">
                ...
                <div class="card-body d-flex flex-column justify-content-between">
                    ...
                    <div>
                        <div class="form-group">
                            <input type="text" name="2Input" class="form-control" id="cell2Input" />
                        </div>
                        <input type="button" class="btn btn-block btn-primary" name="2Button" value="Click me!" id="cell2Button" />
            ...
            <div class="card mb-4 box-shadow">
                ...
                <div class="card-body d-flex flex-column justify-content-between">
                    ...
                    <div>
                        <div class="form-group">
                            <input type="text" name="3Input" class="form-control" id="cell3Input" />
                        </div>
                        <input type="button" class="btn btn-block btn-primary" name="3Button" value="Click me!" id="cell3Button" />
