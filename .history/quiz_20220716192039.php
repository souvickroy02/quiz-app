                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <div>
                                <div class="form-group">
                                    ...
                                    <br>
									<input id="disable3" type="radio" name="Questions' . ($x + 1) . 'Ans" id="Questions' . ($x + 1) . 'Ans3"" value=' . $temp[2] . '>
									<label class="radioButtonBefore" for="Questions' . ($x + 1) . 'Ans3">' . $temp[2] . '</label>
                                    <br>
									<input id="disable4" type="radio" name="Questions' . ($x + 1) . 'Ans" id="Questions' . ($x + 1) . 'Ans4" value=' . $temp[3] . '>
