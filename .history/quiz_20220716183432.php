                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <div>
                                <div class="form-group">
                                    <input   type="radio" name="Questions' . ($x + 1) . 'Ans" id="Questions' . ($ + 1) . 'Ans1" value=' . $temp[0] . '>
									<label class="radioButtonBefore" for="Questions'.($x+1).'Ans1">' . $temp[0] . '</label>
                                    <br>
									<input   type="radio" name="Questions' . ($ + 1) . 'Ans" id="Questions' . ($ + 1) . 'Ans2" value=' . $temp[1] . '>
									<label class="radioButtonBefore" for="Questions' . ($ + 1) . 'Ans2">' . $temp[1] . '</label>
                                    <br>
									<input   type="radio" name="Questions' . ($ + 1) . 'Ans" id="Questions' . ($ + 1) . 'Ans3"" value=' . $temp[2] . '>
									<label class="radioButtonBefore" for="Questions' . ($X + 1) . 'Ans3">' . $temp[2] . '</label>
                                    <br>
									<input  type="radio" name="Questions' . ($ + 1) . 'Ans" id="Questions' . ($ + 1) . 'Ans4" value=' . $temp[3] . '>
									<label class="radioButtonBefore" for="Questions' . ($ + 1) . 'Ans4">' . $temp[3] . '</label>
                                    <br>    
									<input class="hidden" type="hidden" id="correct' . ($ + 1) . '_answer" value=' . $a_arr[$x] . '>
                                </div>
                            </div>
                        </div>
                    </div>
