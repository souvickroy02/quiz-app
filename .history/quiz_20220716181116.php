...
<body>
                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <div>
                                <div class="form-group">
									...
									<label class="radioButtonBefore" for="Questions'.($X+1).'Q3Ans1">' . $temp[0] . '</label>
                                    <br>
									<input   type="radio" name="Questions1Q3" id="Questions' . ($X + 1) . 'Q3Ans2" value=' . $temp[1] . '>
									<label class="radioButtonBefore" for="Questions' . ($X + 1) . 'Q3Ans2">' . $temp[1] . '</label>
                                    <br>
									<input   type="radio" name="Questions1Q3" id="Questions' . ($X + 1) . 'Q3Ans3" value=' . $temp[2] . '>
									<label class="radioButtonBefore" for="Questions1Q3Ans3">' . $temp[2] . '</label>
                                    <br>
									<input  type="radio" name="Questions1Q3" id="Questions' . ($X + 1) . 'Q3Ans4" value=' . $temp[3] . '>
									<label class="radioButtonBefore" for="Questions1Q3Ans4">' . $temp[3] . '</label>
                                    <br>    
									<input class="hidden" type="hidden" id="correct' . ($X + 1) . '_answearQ3" value=' . $a_arr[$x] . '>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row">
            <button type="button" class="btn mb-5 btn-white-reload btn-animation-1-reload submitButton btn-primary btn-lg btn-block" onclick="checkScore3()">Submit</button><br>
        </div>
    </div>

    <script ty src=""></script>
</body>
