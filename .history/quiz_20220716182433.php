                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <div>
                                <div class="form-group">
                                    <input   type="radio" name="Questions' . ($X + 1) . 'Ans" id="Questions' . ($X + 1) . 'Ans1" value=' . $temp[0] . '>
									<label class="radioButtonBefore" for="Questions'.($X+1).'Ans">' . $temp[0] . '</label>
                                    <br>
									<input   type="radio" name="Questions' . ($X + 1) . 'Ans" id="Questions' . ($X + 1) . 'Ans" value=' . $temp[1] . '>
                                    ...
                                    <br>    
									<input class="hidden" type="hidden" id="correct' . ($X + 1) . '_answear" value=' . $a_arr[$x] . '>
                                </div>
                            </div>
                        </div>
                    </div>
