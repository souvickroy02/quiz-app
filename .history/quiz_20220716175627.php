                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <div>
                                <div class="form-group">
                                    <input   type="radio" name="Questions1Q3" id="Questions1Q3Ans1" value=' . $temp[0] . ' required>
									<label class="radioButtonBefore" for="Questions1Q3Ans1">' . $temp[0] . '</label>
                                    <br>
									<input   type="radio" name="Questions1Q3" id="Questions1Q3Ans2" value=' . $temp[1] . ' required>
